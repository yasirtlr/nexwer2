...
const Banner: React.FC<BannerProps> = ({ pageName, backgroundUrl }) => {
  return (
    <section className='pb-[80px] md:pb-[100px] pt-[180px] md:pt-[250px] bg-[#f2f2f2] relative overflow-hidden'>
      ...
      <div className="container z-10 relative">
        <h1 className='text-[40px] md:text-[60px] xl:text-[80px] leading-none text-white'>{pageName}</h1>
      </div>
    </section>
  );
};
